...
namespace WeirdoBot.Modules.Profanity
{
    class ProfanityFilter
    {
        ...
        public static async Task ProfanityBanAsync(DiscordSocketClient bot, SocketMessage pMsg)
        {
            ...
            await Program.Logger(new LogMessage(LogSeverity.Info, "WeirdoCraft Profanity", "Profanity was detected by the user " + pMsg.Author.Username + "."));
        }
    }
}
